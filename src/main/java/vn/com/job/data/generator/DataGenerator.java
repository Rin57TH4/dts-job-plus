package vn.com.job.data.generator;
...
import vn.com.job.data.Role;
import vn.com.job.data.entity.SamplePerson;
import vn.com.job.data.entity.User;
import vn.com.job.data.service.SamplePersonRepository;
import vn.com.job.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 4, 23, 0, 0, 0));
